...
- [Concept List](./concept-list.md) - Complete list of 195 concepts
...
- [Course Description Assessment](./course-description-assessment.md) - Course description quality report
...
1. **Spoken Language** - The starting point for reading instruction
2. **Repetition** - The foundation for practice and mastery

## Longest Learning Path

The maximum dependency chain is 26 concepts, representing the full learning progression:

1. Spoken Language → Listening → Sounds → Speech → Words → Phoneme
2. → Phonemic Awareness → Sound Skills → Blending
3. → Word Reading → Decoding → Accuracy
