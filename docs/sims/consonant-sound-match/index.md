---
title: Consonant Sound Match
description: An interactive MicroSim where kindergarten students click consonant letters to hear their primary sounds with example words and pictures, building systematic letter-sound knowledge.
image: /sims/consonant-sound-match/consonant-sound-match.png
og:image: /sims/consonant-sound-match/consonant-sound-match.png
twitter:image: /sims/consonant-sound-match/consonant-sound-match.png
quality_score: 85
social:
   cards: false
---
...
```html
<iframe src="https://dmccreary.github.io/reading-for-kindergarten/sims/consonant-sound-match/main.html"
        height="452px"
        width="100%"
        scrolling="no"></iframe>
```
...
- [Teaching Letter Sounds](https://www.readingrockets.org/article/teaching-phonemic-awareness-and-letter-sound-correspondence) - Best practices
