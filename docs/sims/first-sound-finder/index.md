---
title: First Sound Finder
description: Listen to a word and identify the first sound from multiple picture choices. Develops phonemic awareness skills critical for early reading success.
image: /sims/first-sound-finder/first-sound-finder.png
og:image: /sims/first-sound-finder/first-sound-finder.png
twitter:image: /sims/first-sound-finder/first-sound-finder.png
social:
   cards: false
---
...
1. **Listen** - Click the "Hear Word" button to hear the target word spoken aloud
2. **Think** - What sound does the word start with?
3. **Find** - Click the picture that starts with the SAME sound
4. **Celebrate** - Correct answers trigger a fun celebration animation!
...
1. Display the MicroSim on the classroom screen
2. Play an example word and model your thinking: "I hear 'ball.' It starts with /b/."
3. Show students how to click the picture that starts with the same sound
4. Demonstrate what happens when they get it right (celebration!)
